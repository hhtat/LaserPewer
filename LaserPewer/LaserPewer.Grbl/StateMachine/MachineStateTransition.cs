namespace LaserPewer.Grbl.StateMachine
{
    public class MachineStateTransition : Transition
    {
        ...
        public MachineStateTransition(State target, GrblStatus.MachineState state)
            : this(target, state, false)
        {
        }

        public MachineStateTransition(State target, GrblStatus.MachineState state, bool negate) : base(target)
        {
            this.state = state;
            this.negate = negate;
        }
